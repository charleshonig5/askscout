    ...
    items: [
      {
        ...
        a: (
          <p>
            askscout is a daily digest tool for developers. It reads your git commits and diffs,
            then generates a clear summary of what you shipped each day. Think of it as a daily
            standup that writes itself, built for solo devs and vibe coders.
          </p>
        ),
      },
      {
        ...
        a: (
          <p>
            ...
            askscout reads your commit messages and diffs and returns a structured digest of what
            shipped, what changed, and what you left off. The web app stores your digest history;
      ...
      },
      {
        ...
        a: (
          <p>
            ...
            software. With the CLI you bring your own API key, which costs roughly $0.001 to
            $0.003 per digest depending on repo size.
          </p>
        ),
      },
      {
        ...
        a: (
          <p>
            ...
            <code>askscout --setup</code> to add your API key. After setup, run{" "}
            <code>askscout</code> in any git repo to generate a digest of recent commits. Full
    ...
    items: [
      {
        ...
        a: (
          <p>
            ...
            uses your own API key, and stores nothing online. Same digest format, two surfaces,
            depending on whether you want a hosted history or a local-only workflow.
          </p>
        ),
      },
      {
      ...
      },
      {
        ...
        a: (
          <p>
            The digest is automatically generated, so it can occasionally miss nuance or
            restate the same change twice. It stays grounded in your actual commit messages and
            diffs rather than working from memory, which keeps the output close to what you
            really shipped. For day-to-day tracking, standup notes, and remembering your work,
            the digest is reliably useful.
          </p>
        ),
      },
      {
        ...
        a: (
          <p>
            ...
            usage limit; the only limits are your provider&apos;s rate limits and your own spend
            on whichever API you connect.
          </p>
        ),
      },
    ],
