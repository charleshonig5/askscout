      ...
      <article className="page-body page-body--reading article article--has-hero">
        ...
        <section className="public-section">
          <p className="public-text">
            Tracking what you shipped used to be a low-stakes problem. You wrote a handful of clean
            commits a day, the messages were yours, and you remembered the work because you typed
        ...
        <section className="public-section">
          ...
          <p className="public-text">
            ...
            <code className="inline-code">-p</code> if you want the actual diffs. Full options in
            the{" "}
            <a
          ...
          <p className="public-text">
            ...
            <code className="inline-code">fix</code>, <code className="inline-code">wip</code>, and{" "}
            <code className="inline-code">update</code>, the log is illegible. You can scan it. You
            cannot understand it.
          </p>
          <p className="public-text">Use this when the week is small and the messages are real.</p>
        </section>
        ...
        <section className="public-section">
          ...
          <p className="public-text">
            ...
            contribution graph, and a pull-request summary. It is the easiest way to see the shape
          ...
          <p className="public-text">
            What Insights does badly: it shows counts. Counts are not summaries. Insights will tell
            you that you made 73 commits last week. It will not tell you what those commits did. If
            you want narrative, you have to read the diffs yourself.
          </p>
          <p className="public-text">Use this when you want a sense of pace, not detail.</p>
        </section>
        ...
        <section className="public-section">
          ...
          <p className="public-text">
            Journals capture the one thing automated tools miss: intent. You can record why you did
            something, not just what changed. That context compounds over months.
          </p>
          <p className="public-text">
            The catch is that journals only work if you actually keep them. The first two weeks are
            easy. The third week you forget once. The fourth week you stop. I have started and
            abandoned more dev journals than I can count, and I run a daily-digest company.
          </p>
          <p className="public-text">
        ...
        <section className="public-section">
          ...
          <p className="public-text">
            ...
            is one of these. So is anything you build yourself by piping git diffs into a ChatGPT or
            Claude prompt.
          </p>
          <p className="public-text">
            What you get is a written digest with sections: what shipped, what changed, what kept
            getting reworked, and where you left off. The output is short enough to skim in about a
            minute. The data is grounded in your actual commits, not your memory. (For a tour of how
          ...
          <p className="public-text">
            What you give up is some control. The summary is the model&apos;s read of your diffs,
            not yours. If the model misreads a commit, the digest reflects that. You also pay a
            small LLM cost per run if you bring your own key (a fraction of a cent at default
            models). The hosted web app is free.
          </p>
          <p className="public-text">
        ...
        <section className="public-section">
          ...
          <p className="public-text">
            If your week is AI-assisted-volume with messy auto-generated messages, the only option
            that scales is automation. Either build the prompt yourself or use a tool like askScout.
            The point is that something is reading your repo for you, because at this volume you are
            not going to.
          </p>
          <p className="public-text">
